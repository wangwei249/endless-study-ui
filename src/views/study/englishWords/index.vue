<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['study:englishWords:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['study:englishWords:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['study:englishWords:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['study:englishWords:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="englishWordsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="单词变换" align="center" prop="exchange" />
      <el-table-column label="发音" align="center" prop="voice" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="单词变换" prop="exchange">
          <el-input v-model="form.exchange" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="发音" prop="voice">
          <el-input v-model="form.voice" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="时长" prop="times">
...
<script>
import { listEnglishWords, getEnglishWords, delEnglishWords, addEnglishWords, updateEnglishWords } from "@/api/study/englishWords";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除英语单词编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('study/englishWords/export', {
        ...this.queryParams
      }, `study_englishWords.xlsx`)
    }
  }
};
</script>