<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="生词状态：S/在生存，D/已消灭" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择生词状态：S/在生存，D/已消灭" clearable size="small">
          <el-option label="请选择字典生成" value="" />
        </el-select>
      </el-form-item>
      <el-form-item label="已练习错误次数" prop="wrongTimes">
        <el-input
          v-model="queryParams.wrongTimes"
          placeholder="请输入已练习错误次数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="正确次数" prop="rightTimes">
        <el-input
          v-model="queryParams.rightTimes"
          placeholder="请输入正确次数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="上一次正确时间" prop="lastRigthTime">
        <el-date-picker clearable size="small" style="width: 200px"
          v-model="queryParams.lastRigthTime"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="选择上一次正确时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="newWordsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生词状态：S/在生存，D/已消灭" align="center" prop="status" />
      <el-table-column label="已练习错误次数" align="center" prop="wrongTimes" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="生词状态：S/在生存，D/已消灭">
          <el-radio-group v-model="form.status">
            <el-radio label="1">请选择字典生成</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="已练习错误次数" prop="wrongTimes">
          <el-input v-model="form.wrongTimes" placeholder="请输入已练习错误次数" />
        </el-form-item>
        <el-form-item label="正确次数" prop="rightTimes">
          <el-input v-model="form.rightTimes" placeholder="请输入正确次数" />
        </el-form-item>
        <el-form-item label="上一次正确时间" prop="lastRigthTime">
          <el-date-picker clearable size="small" style="width: 200px"
            v-model="form.lastRigthTime"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="选择上一次正确时间">
          </el-date-picker>
...
<script>
import { listNewWords, getNewWords, delNewWords, addNewWords, updateNewWords } from "@/api/study/newWords";
